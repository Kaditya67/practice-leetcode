...
- [ ] Complexity classes and constraint-based method selection.
- [ ] Vector growth, capacity vs size, amortized analysis.
- [ ] Iterators and range-based traversal correctness.
- [ ] `map` vs `unordered_map` tradeoffs.
- [ ] Custom comparator for `priority_queue`.
Exit criteria:
- [ ] Solve 8 to 10 mixed STL and complexity problems.
- [ ] Explain why each accepted solution meets time and space limits.
